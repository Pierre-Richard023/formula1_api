 ...
 */
final class Version20241104212441 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE standings ADD CONSTRAINT FK_93670F67613FECDF FOREIGN KEY (session_id) REFERENCES sessions (id)');
